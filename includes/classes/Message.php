...
class Message {
	...
	public function getMessages($otherUser) {
		...
		while($row = mysqli_fetch_array($get_messages_query)) {
			...
			$div_top = ($user_to == $userLoggedIn) ? "<button class='message' data-toggle='tooltip' data-placement='right' title='".$time_message."' id='white'>" : "<button class='message' data-toggle='tooltip' data-placement='left' title='".$time_message."' id='blue'>";

			$data = $data . $div_top . $body . "</button><br><br>";
